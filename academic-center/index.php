...
<head>
    ...
    <title>Reception Display | Academic Centre</title>
        ...
        <header class="px-10 py-2 flex justify-between items-center bg-white border-b border-slate-200 z-20">
            <div class="flex items-center gap-6">
                ...
                <div class="flex gap-5">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold tracking-tight text-slate-900">PGIM Academic Centre</h1>
            ...
            <div class="flex items-center gap-10">
                <div class="text-right">
                    <div id="digitalClock" class="text-4xl font-black tracking-tight text-slate-800 leading-none">00:00:00</div>
